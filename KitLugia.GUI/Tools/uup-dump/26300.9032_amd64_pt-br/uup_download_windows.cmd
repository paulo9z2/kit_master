@echo off
:: Generated on 2026-08-01 00:00:27 GMT
...
:START_PROCESS
title 26300.9032_amd64_pt-br_professional_10c2347e download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=10c2347e-f1b1-43ee-8442-3ded03f519c5&pack=pt-br&edition=PROFESSIONAL&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
