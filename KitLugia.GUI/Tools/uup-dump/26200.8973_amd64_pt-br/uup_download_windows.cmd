@echo off
:: Generated on 2026-08-01 00:06:50 GMT
...
:START_PROCESS
title 26200.8973_amd64_pt-br_professional_b407eb4e download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=b407eb4e-c0c2-47e8-a60c-ae837d058d1e&pack=pt-br&edition=PROFESSIONAL&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
